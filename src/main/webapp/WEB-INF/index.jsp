    ...
    <div class="p-5">
      ...
      <form:form modelAttribute="newCustomer" action="/register" method="post" class="form gap-3 d-flex flex-column">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center gap-2">
          ...
          <form:label path="personalNumberId">Personal Number</form:label>
          <form:input path="personalNumberId" type="text" class="form-control"/>
        </div>
        <div class="d-flex flex-column justify-content-center align-items-center gap-2">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center gap-2">
          ...
          <form:input path="passConfirm" type="password" class="form-control"/>
        </div>
